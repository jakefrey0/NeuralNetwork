...
namespace NeuralNet {
	...
	public static class Visualization {
		...
		private static Font font=new Font("Verdana",8,FontStyle.Italic);
		...
		public static void drawNeurons (List<List<Neuron>> layers) {
			...
			using (Graphics g=Graphics.FromHdc(dc)) {
				...
				g.FillRectangle(pen0.Brush,new Rectangle(0,0,700,1000));
